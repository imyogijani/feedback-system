...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    $_SESSION['message'] = $action ? "Request active." : "Request deactivated.";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="get" style="display:inline;">
                                                    ...
                                                    <input type="hidden" name="action" value="<?= $request['is_active'] ? 'unapprove' : 'approve' ?>">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" name="toggle_approve" onchange="this.form.submit()" <?= $request['is_active'] ? 'checked' : '' ?> >
                                                        <label class="form-check-label">
                                                            <?= $request['is_active'] ? 'Active' : 'Deactivate' ?>
                                                        </label>
                                                    </div>
                                                </form>
                                            </td>
